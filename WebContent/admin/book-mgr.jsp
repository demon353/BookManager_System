    ...
    <div id="container">
    	...
    	<div id="main">
				...
				<table class="table" cellspacing="0" style="font-size: 12px;">
			    	...
			    	<c:forEach items="${list }" var="b">
			    		<tr>
				    		...
				    		<td><a href="${pageContext.request.contextPath}/BookController?op=delete&id=${b.id }">删除</a>&nbsp;<a href="${pageContext.request.contextPath}/BookController?op=findById&id=${b.id }">编辑</a></td>
				    	</tr>
			    	</c:forEach>
			    </table>
			</div>
			<div class="section-right">
				<h2>添加图书信息</h2>
				<form action="${pageContext.request.contextPath}/BookController?op=add" method="post" enctype="Multipart/form-data">
